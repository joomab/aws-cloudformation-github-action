...
1. Desplegar los recursos necesarios para el despliegue desde Github Actions a AWS en las cuentas de ambientes (ej. Dev, QA, Prod).
...
# (Paso 1) Desplegar los recursos necesarios para el despliegue desde Github Actions a AWS en las cuentas de ambientes (ej. Dev, QA, Prod).
...
(Repetir esto por cada ambiente, en este ejemplo asumiremos solo DEV y el prefijo de todos los secretos serán DEV_) Dentro del repositorio en Settings > Secrets and variables > Actions > Secrets, en el apartado de Repository secrets, agregar los siguientes secretos:


- DEV_ACCESS_KEY: El Access Key del usuario programatico a utilizar (Para ambiente de Dev).
- DEV_SECRET_ACCESS_KEY: El Secret Key del usuario programatico a utilizar (Para ambiente de Dev).
...
Dentro del repositorio en Settings > Secrets and variables > Actions > Variables, en el apartado de Repository variables, agregar las siguientes variables:

- DEV_STACK_NAME: El nombre del stack con el que quieras que se cree en cloudformation (Para ambiente de Dev).
